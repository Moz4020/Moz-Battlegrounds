        ...
        <div class="options-layout">
            ...
            <div class="options-toggle-grid">
              ${!(
                ...
                ? this.renderToggle(
                    ...
                    translateText("host_modal.tooltip_disable_nations"),
                  )
                : ""}
              ${this.renderToggle(
                "instant-build",
                ...
                translateText("host_modal.tooltip_instant_build"),
              )}
              ${this.renderToggle(
                "random-spawn",
                this.randomSpawn,
                ...
                translateText("host_modal.tooltip_random_spawn"),
              )}
              ${this.renderToggle(
                "donate-gold",
                this.donateGold,
                ...
                translateText("host_modal.tooltip_donate_gold"),
              )}
              ${this.renderToggle(
                "donate-troops",
                this.donateTroops,
                ...
                translateText("host_modal.tooltip_donate_troops"),
              )}
              ${this.renderToggle(
                "infinite-gold",
                this.infiniteGold,
                ...
                translateText("host_modal.tooltip_infinite_gold"),
              )}
              ${this.renderToggle(
                "infinite-troops",
                this.infiniteTroops,
                ...
                translateText("host_modal.tooltip_infinite_troops"),
              )}
              ${this.renderToggle(
                "free-nukes",
                this.freeNukes,
                translateText("host_modal.free_nukes"),
                this.handleFreeNukesChange,
                translateText("host_modal.tooltip_free_nukes"),
              )}
              ${this.renderToggle(
                "permanent-allies",
                this.permanentAllies,
                translateText("host_modal.permanent_allies"),
                this.handlePermanentAlliesChange,
                translateText("host_modal.tooltip_permanent_allies"),
              )}
              ${this.renderToggle(
                "host-modal-compact-map",
                this.compactMap,
                translateText("host_modal.compact_map"),
                this.handleCompactMapChange,
                translateText("host_modal.tooltip_compact_map"),
              )}
              ...
              >
                <span class="option-toggle__label"
                  >${translateText("host_modal.max_timer")}</span
                >
                <input
                  type="checkbox"
                  id="host-max-timer"
          ...
          <div class="options-section">
            ...
            <lobby-team-view
              ...
              .isHost=${true}
              .onSwapTeam=${(clientID: string, team: string) =>
                this.handleSwapTeam(clientID, team)}
