...
export class JoinPrivateLobbyModal extends LitElement {
  ...
  render() {
    return html`
      <o-modal modal-title=${translateText("private_lobby.title")}>
        <div class="lobby-id-bar">
          <input
            ...
            style="background: transparent; border: none; color: white; outline: none; flex-grow: 1; font-family: monospace; font-size: 16px;"
          />
          <button
